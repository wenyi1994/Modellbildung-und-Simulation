%% Schwingerkette_Bearbeitungsfile.m
%  - Systemmatrix erstellen
%  - Anfangsbedigungen einsetzen
%  - Loesung der Gleichung mit Heun-Verfahren berechnen
%  - Eigenfrequenzen mit steigenden Federsteifigkeiten wieder berechnen
%  - Ergebnis plotten
%  ----------------------------------------------------------------------
%  Output:
%       - Grafik Auslenkung (x1, x2) mit Laufzeit
%       - Grafik Geschwindigkeit (x1, x2) mit Laufzeit
%       - Grafik Eigenfrequenzen mit Federsteifigkeit
%  ----------------------------------------------------------------------
